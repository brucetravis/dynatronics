...
// An array of category cards
const  categoryCardsData = [
    { id: 1, text: "Gaming", class: "category-card electric"},
    { id: 2, text: "Laptops", class: "category-card red-electric"},
    { id: 3, text: "Accessories", class: "category-card purple-electric"},
...
// Export the category cards data (texts, classNames)
